      ...
      <Container>
        <Card>
          <CardContent>
            ...
            <StyledList>
              <StyledListItem>Teav3 will be a fully audited version of the PoTATO Protocol.</StyledListItem>
