...
const Home: React.FC = () => {
  ...
  return (
    <Page>
      ...
      <PageHeader icon="" subtitle="Tato is a token seeking price stability with elastic supply monetary model and governable treasury, derived mechanics from some high yield farming projects such as Yam and SushiSwap, with redesigned fair and prolonged distribution model, and support from more vibrant communities." title="Potato Protocol" />
      <div style={{
