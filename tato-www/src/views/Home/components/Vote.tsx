    ...
    <Card>
      <CardContent>
        ...
        {!delegated ? (
          ...
          <StyledLink target="__blank" href="https://twitter.com/tato_finance">More Info</StyledLink>
        </div>
      </CardContent>
    </Card>
  )
...
const StyledCheckpoint = styled.div<StyledCheckpointProps>`
  ...
  &:after {
    ...
    position: absolute;
    width: 1px;
    background-color: ${props => props.acheived ? props.theme.color.secondary.main : props.theme.color.black};
    height: 28px;
    left: 0;
