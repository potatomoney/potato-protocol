        ...
        <>
          <Route exact path={path}>
              ...
              <PageHeader
                ...
                subtitle="Earn TATO tokens by staking with following coins."
                title="Select a Farm."
              />
              <StyledTimeWord>
            ...
            <StyledStake>
               ...
               <StyledStakeDesc>Providing liquidity for <a target="_blank" href="https://uniswap.info/pair/0xB8756aB02f38bc7720348A8adc024A95926459FB">TATO-yCRV pair</a>  on Uniswap to obtain Uniswap LP token, staking to the following pool to yield. Distrbuting 3571 TATO per hour.</StyledStakeDesc>
               <StakeCards />
            </StyledStake>
          ...
          <StyledLinkBox>
                  ...
                  <a href='https://etherscan.io/token/0xbC226d2651778B7866145242569eB975faff9884' target="_blank" style={{color:'#757E94',fontSize:'14px',margin:'0 30px 0 0'}}>Smart Contract</a>
                  <a href='https://uniswap.info/pair/0xB8756aB02f38bc7720348A8adc024A95926459FB' target="_blank" style={{color:'#757E94',fontSize:'14px',margin:'0 30px 0 0'}}>Uniswap TATO-yCRV</a>
          </StyledLinkBox>
        </>
      ) : (
        <div style={{
