...
import "./TATODelegate.sol";

contract TATODelegator is TATOTokenInterface, TATODelegatorInterface {
    /**
     * @notice Construct a new TATO
    ...
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == gov, "TATODelegator::_setImplementation: Caller must be gov");
    ...
    function () external payable {
        require(msg.value == 0,"TATODelegator:fallback: cannot send value to fallback");
